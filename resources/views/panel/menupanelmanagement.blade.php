...
@section('title', 'مدیریت منوهای داشبورد')

@section('content')
    <div class="card">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h5 class="card-title mb-0">لیست منوهای داشبورد</h5>
                <a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#menuModal">افزودن منو داشبورد</a>
            </div>
            ...
            <div class="table-responsive">
                <table class="table table-bordered text-center">
                    ...
                    <tr>
                        ...
                        <td>پنل</td>
                        <td>panel</td>
                        <td>PanelController</td>
                        <td>دارد</td>
                        <td><span class="badge bg-success">در حال نمایش</span></td>
                        <td>
                            <button class="btn btn-sm btn-icon btn-outline-primary" data-bs-toggle="modal" data-bs-target="#menuModal"><i class="mdi mdi-pencil-outline"></i></button>
    ...
    <div class="modal fade" id="menuModal" tabindex="-1" aria-labelledby="menuModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="menuModalLabel">ورود اطلاعات منو داشبورد</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="بستن"></button>
                </div>
                <div class="modal-body">
                    <form>
                        <div class="row mb-3">
                            <div class="col-md-4">
                                <label class="form-label">نام منو داشبورد</label>
                                <input type="text" class="form-control" placeholder="نام منو داشبورد را وارد کنید">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label">لیبل منو داشبورد</label>
                                <input type="text" class="form-control" placeholder="لیبل منو را وارد کنید">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label">آدرس صفحه</label>
                                <input type="text" class="form-control" placeholder="آدرس صفحه را وارد کنید">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" placeholder="کلاس کنترلر را وارد کنید">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label">زیر منو داشبورد</label>
        ...
        function confirmDelete() {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Swal.fire('حذف شد!', 'منو با موفقیت حذف شد.', 'success');
                }
            });
        }
    </script>
